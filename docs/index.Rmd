...
RNAP-II and RNASeq correlation was computed using normalised read count over the gene-body. Scatterplot of normalised read count and FPKM values were plotted using scatter plot functionality of [FungiExpresZ](https://cparsania.shinyapps.io/FungiExpresZ/)

1. RNAP-II

```{r,echo=FALSE, out.width = "700px",fig.align='center'}
knitr::include_graphics(plots["An_RNAP2_expression_scatterplot.png"])
```

2. RNASeq

```{r,echo=FALSE, out.width = "400px",fig.align='center'}
knitr::include_graphics(plots["An_mRNA_expression_scatterplot.png"])
```
