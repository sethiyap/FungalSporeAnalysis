...
#' @param bw_test A character vector containing name of the bw file object.
#' @param bw_control A character vector containing name of the bw file object to
#'   normalize the bw_test.
