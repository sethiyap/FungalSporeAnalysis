...
#'
#' }
lineplot_for_bw <- function(feature_txDb,genelist,bw_file,output_name="Sample", tss="TRUE", expression_value=TRUE, tiles=4){
          ...
          gg <- ggplot2::ggplot(summarised_mat,ggplot2::aes(column_name,median, group=quantile, color=quantile))+
