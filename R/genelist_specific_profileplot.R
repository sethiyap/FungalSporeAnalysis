...
#'
#' }
genelist_specific_profileplot <- function(feature_txDb,bw_files,genelist=NULL,tss=TRUE,palette="cream_brown",max_key=6, min_key=0, ymax=6,ymin=1,log2=TRUE,rename=FALSE,output=TRUE,output_name="Sample"){
